...
describe("API ENDPOINT TESTING", () => {
  ...
  it("GET Detail Page", (done) => {
    chai
      ...
      .end((err, res) => {
        ...
        expect(res).to.have.status(200);
        expect(res.body).to.be.an("Object");
        expect(res.body).to.be.have.property("country");
        expect(res.body).to.be.have.property("isPopular");
        expect(res.body).to.be.have.property("unit");
        expect(res.body).to.be.have.property("sumBooking");
        expect(res.body).to.be.have.property("imageId");
        expect(res.body.imageId).to.have.an("array");
        expect(res.body).to.be.have.property("featureId");
        expect(res.body.featureId).to.have.an("array");
        expect(res.body).to.be.have.property("activityId");
        ...
        expect(res.body).to.be.have.property("price");
        expect(res.body).to.be.have.property("city");
        expect(res.body).to.be.have.property("description");
        expect(res.body).to.be.have.property("__v");
        expect(res.body).to.be.have.property("bank");
  ...
  it("POST Booking Page", (done) => {
    ...
    const dataSample = {
      ...
      firstName: "Radha",
      lastName: "Sejati",
      email: "radhasjt@gmail.com",
      phoneNumber: "0812324224242",
      accountHolder: "Radha",
      bankFrom: "BNI",
    };
    chai
